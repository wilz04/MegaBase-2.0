...
Public Class SalesByTimeAndClient
    ...
    Public Overrides Property ResourceName As String
        Get
            Return "SalesByTimeAndClient.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSalesByTimeAndClient
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SalesByTimeAndClient = New SalesByTimeAndClient
        rpt.Site = Me.Site
        Return rpt
    End Function
