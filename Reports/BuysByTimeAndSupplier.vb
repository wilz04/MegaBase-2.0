...
Public Class BuysByTimeAndSupplier
    ...
    Public Overrides Property ResourceName As String
        Get
            Return "BuysByTimeAndSupplier.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedBuysByTimeAndSupplier
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As BuysByTimeAndSupplier = New BuysByTimeAndSupplier
        rpt.Site = Me.Site
        Return rpt
    End Function
